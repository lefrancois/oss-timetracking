<div x-data="{ open: false }" x-cloak>
    <div class="flex shadow-sm ring-1 ring-offset-2 ring-cosu-100 justify-between group cursor-pointer p-2 rounded bg-gradient-to-r from-white to-cosu-50 relative">
        <div class="flex-grow">
