        ...
        <div class="relative overflow-hidden">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6">
                    <nav class="relative flex items-center justify-between sm:h-10 md:justify-center" aria-label="Global">
                        <div class="flex items-center flex-1 md:absolute md:inset-y-0 md:left-0">
                            <div class="fixed top-0 left-0 md:relative py-2 flex items-center justify-between w-full md:w-auto bg-gray-50 shadow md:shadow-none z-50">
                                    <img class="h-8 w-auto sm:h-10 ml-4" src="{{ asset('svg/cosu_plain.svg') }}" alt="">
                                <div class="mr-4 flex items-center md:hidden">
                                    <button @click="menuOpen = !menuOpen" type="button" class="bg-gray-50 rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500" id="main-menu"
                                            aria-haspopup="true">
                    ...
                    <div class="fixed top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden z-50" x-show="menuOpen" x-transition.duration.500ms>
                        <div class="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
                            <div class="px-5 pt-4 flex items-center justify-between">
                                <div>
                                    <img class="h-8 w-auto sm:h-10" src="{{ asset('svg/cosu_plain.svg') }}" alt="">
                                </div>
                                <div class="-mr-2">
                                    <button @click="menuOpen = false" type="button" class="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
                            ...
                            <div role="menu" aria-orientation="vertical" aria-labelledby="main-menu">
                                <div class="px-2 pt-2 pb-3 space-y-1" role="none">
                                    <a href="#" @click="menuOpen = false" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50" role="menuitem">Product</a>

                                    <a href="#features" @click="menuOpen = false" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50" role="menuitem">Features</a>

                                    <a href="#pricing" @click="menuOpen = false" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50" role="menuitem">Pricing</a>
                    ...
                    <div class="text-center">
                        ...
                        <div class="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-8">
                            ...
                            <div class="mt-3 rounded-md shadow sm:mt-0 sm:ml-3">
                                <a href="#features" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-cosu-600 bg-white hover:bg-gray-50 md:py-4 md:text-lg md:px-10">
                                    Features
                                </a>
                            </div>
                        </div>
            ...
            <div class="relative">
                <div class="absolute inset-0 flex flex-col" aria-hidden="true">
                    ...
                    <div class="flex-1 w-full bg-cosu-700"></div>
                </div>
                <div class="max-w-7xl mx-auto px-4 sm:px-6 pb-20">
                    <img class="relative rounded-lg shadow-lg" src="{{ asset('assets/images/hero-preview.png') }}" alt="App screenshot">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="py-12 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="lg:text-center">
                <h2 id="features" class="text-base text-cosu-600 font-semibold tracking-wide uppercase">Features</h2>
                ...
                <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <div class="flex items-center justify-center h-12 w-12 rounded-md bg-cosu-500 text-white">
                ...
                <div class="max-w-4xl mx-auto">
                    <dl class="rounded-lg bg-white shadow-lg sm:grid sm:grid-cols-3">
                        <div class="flex flex-col border-b border-gray-100 p-6 text-center sm:border-0 sm:border-r">
                            ...
                            <dd class="order-1 text-5xl font-extrabold text-cosu-600">
            ...
            <div class="pt-12 px-4 sm:px-6 lg:px-8 lg:pt-20">
                <div class="text-center">
                    ...
                    <p class="mt-3 max-w-4xl mx-auto text-xl text-gray-300 sm:mt-5 sm:text-2xl">
                        We like to share our tool and will never charge you for any base features*.
                    </p>
                </div>
            </div>
                ...
                <div class="relative z-0">
                    ...
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div class="relative lg:grid lg:grid-cols-7">
                            ...
                            <div class="mt-10 max-w-lg mx-auto lg:mt-0 lg:max-w-none lg:mx-0 lg:col-start-3 lg:col-end-6 lg:row-start-1 lg:row-end-4">
                                <div class="relative z-10 rounded-lg shadow-xl">
                                    <div class="pointer-events-none absolute inset-0 rounded-lg border-2 border-cosu-600" aria-hidden="true"></div>
                                    <div class="absolute inset-x-0 top-0 transform translate-y-px">
                                        <div class="flex justify-center transform -translate-y-1/2">
                                        <span class="inline-flex rounded-full bg-cosu-600 px-4 py-1 text-sm font-semibold tracking-wider uppercase text-white">
                                  Most popular
                              </span>
                                        </div>
                                    </div>
                        ...
                        <div class="mt-6 text-center text-gray-500 text-sm">
                            * More upcoming stuff like CSV/XLS export, tags, charts, etc. will be free forever too
                        </div>
                    </div>
                </div>
            </div>
