...
@section('page')
    <div class="container prose mx-auto py-8 dark:prose-invert">
        ...
        <p>
            When visiting our website, statistical analyses may be made of your surfing behavior. This happens primarily using cookies and analytics. The analysis of your surfing behavior is usually anonymous, i.e. we will not be able to identify you from this data. You can object to this analysis or prevent it by not using certain tools. Details can be found in our privacy policy under the heading "Third-party modules and analytics."<br>
        ...
        <p>
            ...
            Michael Lefrancois<br>
            Lerchenstr. 16<br>
            63150 Heusenstamm, Germany<br>
            Email: info@cosu.io<br>
        ...
        <p>
            This website uses Fathom Analytics. Fathom is a simple, light-weight, privacy-first alternative to Google Analytics. Because Fathom doesn’t collect any personal data and are GDPR, PECR and CCPA compliant, we don’t need cookie notices. For more information: <a href="https://usefathom.com/ref/ABAKKC">Fathom Analytics</a>
        </p>
    </div>
@endsection
