<div>
    <div x-data x-cloak x-show="$wire.showDetails" :class="`fixed inset-0 overflow-hidden z-50 ${ $wire.showDetails ? 'pointer-events-auto' : 'pointer-events-none' }`">
        <div class="absolute inset-0 overflow-hidden">
            <div x-show="$wire.showDetails" x-transition.opacity.duration.500ms class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-all" aria-hidden="true" wire:click="closeTimerDetails"></div>
                                ...
                                <div class="mt-4">
                                    <div class="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-1">
                                                <textarea id="notes" type="text" name="notes" class="shadow-sm focus:ring-cosu-500 focus:border-cosu-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="{{ __('Notes') }}" wire:model.defer="item.notes" rows="5"></textarea>
                                                @error('item.notes')
                                                <div class="text-xs text-red-700 mt-1">{{ $message }}</div>
                                                @enderror
                                            </div>
